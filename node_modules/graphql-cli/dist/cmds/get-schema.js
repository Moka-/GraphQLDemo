...
function update(context, argv) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_f) {
            switch (_f.label) {
                case 0:
                    if (!isUrl(argv.endpoint)) return [3 /*break*/, 3];
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    endpoint = new graphql_config_1.GraphQLEndpoint({ url: argv.endpoint, headers: endpointHeaders });
...
function updateSingleProjectEndpoint(config, endpoint, endpointName, argv) {
    return __awaiter(this, void 0, void 0, function () {
        var newSchemaResult, _a, oldSchema, newSchema, schemaPath;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    log("Downloading introspection from " + chalk_1.default.blue(endpoint.url));
                    if (!argv.json) return [3 /*break*/, 2];
                    return [4 /*yield*/, endpoint.resolveIntrospection()];
                case 1:
                    _a = _b.sent();
                    return [3 /*break*/, 4];
                case 2: return [4 /*yield*/, endpoint.resolveSchema()];
                case 3:
                    _a = _b.sent();
                    _b.label = 4;
                case 4:
                    ...
                    if (!argv.console) {
                        ...
                        if (oldSchema) {
                            ...
                            if (newSchema === oldSchema) {
                                log(chalk_1.default.green("" + (config && config.projectName && config.projectName !== 'unnamed' ? "project " + chalk_1.default.blue(config.projectName) + " - " : '') + (endpointName && endpointName !== 'unnamed' ? "endpoint " + chalk_1.default.blue(endpointName) + " - " : '') + "No changes"));
                                emitter.emit('checked');
                                return [2 /*return*/];
                            }
                        }
                    }
                    if (!argv.console) return [3 /*break*/, 5];
                    console.log(argv.json
                        ? JSON.stringify(newSchemaResult, null, 2)
                        : graphql_1.printSchema(newSchemaResult));
                    return [3 /*break*/, 8];
                case 5:
                    if (!argv.json) return [3 /*break*/, 6];
                ...
                case 8:
                    if (schemaPath) {
                        log(chalk_1.default.green("" + (config && config.projectName && config.projectName !== 'unnamed' ? "project " + chalk_1.default.blue(config.projectName) + " - " : '') + (endpointName && endpointName !== 'unnamed' ? "endpoint " + chalk_1.default.blue(endpointName) + " - " : '') + "Schema file was " + (oldSchema ? 'updated' : 'created') + ": " + chalk_1.default.blue(path_1.relative(process.cwd(), schemaPath))));
                    }
                    emitter.emit('checked');
                    return [2 /*return*/];
            }
    ...
    if (argv.endpoint) {
        if (Array.isArray(argv.endpoint)) {
            ...
            endpoints = Object.keys(config.endpointsExtension.getRawEndpointsMap()).reduce(function (total, current) {
                lodash_1.merge(total, (_a = {}, _a[current] = config.endpointsExtension.getEndpoint(current), _a));
                return total;
                var _a;
            }, {});
        }
        else {
            endpoints = (_a = {}, _a[argv.endpoint] = config.endpointsExtension.getEndpoint(argv.endpoint), _a);
        }
    }
    else {
