...
function handler(context) {
    return __awaiter(this, void 0, void 0, function () {
        var prompt, config, extensionEndpoints, configFormat, configFilename, configData, confirmSave;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    extensionEndpoints = {};
                    _a.label = 2;
                case 2: return [4 /*yield*/, addEndpoint(prompt, extensionEndpoints)];
                case 3:
                ...
                case 5:
                    configFormat = (_a.sent()).configFormat;
                ...
                case 6:
                    confirmSave = (_a.sent()).confirmSave;
                    if (confirmSave) {
